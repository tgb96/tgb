  ...
  return {
    ...
    async analyzeRoutine(record, recentRecords = [], planDetails = [], context = {}) {
      ...
      const instructions = [
        ...
        "changes debe contener exclusivamente modificaciones numéricas reales que TGTrain pueda guardar: series, repeticiones/tiempo o carga cuyo valor proposed sea distinto del valor current. Si recomiendas mantener carga, técnica o configuración, deja changes vacío y explícalo en nextSession; no generes una entrada action=maintain. Si sugieres sustituir un ejercicio, descríbelo en nextSession y deja changes vacío porque la app no aplica sustituciones automáticas. Nunca apliques nada: la aplicación pedirá confirmación al usuario.",
