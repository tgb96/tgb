const CACHE_NAME = "tgtrain-shell-v76";
...
const APP_SHELL = [
  ...
  "./assets/js/nutrition.js?v=76",
  "./assets/js/nutrition-presets.js?v=75",
  "./assets/js/nutrition-ui.js?v=76",
