...
La integración personal con Xiaomi Smart Band mediante Health Connect está en [TGTrain Sync para Android](android/tgtrain-sync/README.md). [Descarga el APK instalable](downloads/tgtrain-sync-0.4.0.apk), inicia sesión con la misma cuenta de TGTrain y sincroniza desde la app puente. Los datos aparecen en Inicio y puedes vincular cada sesión de la pulsera con el entrenamiento manual correspondiente desde Historial, sin duplicarlo. La versión 0.4.0 intenta actualizar los datos cada 30 minutos con el permiso de segundo plano de Health Connect, también al abrir la app puente, y busca el sueño en las fuentes de Mi Fitness aunque difieran de la fuente de pasos. Para registros manuales de cardio o tenis, una hora aproximada de inicio opcional ayuda a encontrar la sesión correcta. La vinculación siempre requiere confirmación.
...
- Diario de comidas y agua por día, con edición y eliminación. Cada comida se anota como se consumió realmente; calorías y macros se estiman a partir de los ingredientes seleccionados, no del texto libre, y siempre pueden corregirse manualmente.
- Cada comida se arma con ingredientes individuales repetibles: pan, huevos, palta, láminas de queso y jamón, frutas en porciones, arroz, carnes y otros. Las ideas del plan siguen visibles como orientación, pero ya no se registran como combos. El pan Ideal 100% Integral usa la [tabla de su envase](https://www.jumbo.cl/pan-molde-100-int-2087389/p): 73 kcal por rebanada. Para los otros alimentos se usan porciones promedio y estimaciones genéricas ilustrativas, tomando [USDA FoodData Central](https://fdc.nal.usda.gov/) como referencia general para alimentos sin marca; no son mediciones de la comida ni etiquetas de los envasados. La palta se toma como una porción normal de 50 g. Los registros anteriores con ingredientes pero sin macros reciben y sincronizan la estimación automáticamente; nunca se sustituyen cifras manuales. Las fotos y aclaraciones futuras se reflejan editando la comida, sin análisis automático de imágenes en esta versión.
- Avena, miel y kiwi ya no aparecen entre los ingredientes elegibles ni en las sugerencias. Si estaban en un registro antiguo, ese historial y sus cifras se conservan.
