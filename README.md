...
- Cada comida se arma con ingredientes individuales repetibles: pan, huevos, palta, láminas de queso y jamón, frutas en porciones, arroz, carnes y otros. Las ideas del plan siguen visibles como orientación, pero ya no se registran como combos. Solo el pan Ideal 100% Integral usa automáticamente la [tabla de su envase](https://www.jumbo.cl/pan-molde-100-int-2087389/p): 73 kcal por rebanada. El resto queda sin total automático hasta conocer cantidades o etiquetas; se puede escribir un valor manual revisado.
